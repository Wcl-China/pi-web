export const SESSION_ROW_CONTEXT_MENU_EVENT = "jiyun-web:session-row-contextmenu";
...
declare global {
  interface WindowEventMap {
    "jiyun-web:session-row-contextmenu": CustomEvent<SessionRowContextMenuDetail>;
  }
}
