...
- `latte/` is used in Jiyun Web's light theme.
- `mocha/` is used in Jiyun Web's dark theme.
- Jiyun Web uses the SVG alpha channel as a mask and applies `var(--text-dim)`,
